...
4. Format links in your response as full URLs (e.g., "Check out https://github.com/aahil-khan/skillmap") so the frontend can make them clickable and dont add "." in the end of the link
